...
HD_PWD='/home/filipe/Documentos/Matérias/Projetos-de-Circuitos-Reconfigur-veis_UnB_2019_1/Estacionamento/Estacionamento.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log estacionamento.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source estacionamento.tcl
