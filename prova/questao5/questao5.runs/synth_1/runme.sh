...
HD_PWD='/home/filipe/Documentos/Matérias/Projetos-de-Circuitos-Reconfigur-veis_UnB_2019_1/prova/questao5/questao5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_4.tcl
