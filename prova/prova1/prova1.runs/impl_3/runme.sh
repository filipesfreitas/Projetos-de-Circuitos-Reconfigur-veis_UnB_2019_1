...
HD_PWD='/home/filipe/Documentos/Matérias/Projetos-de-Circuitos-Reconfigur-veis_UnB_2019_1/prova/prova1/prova1.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log dis_est.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dis_est.tcl -notrace
