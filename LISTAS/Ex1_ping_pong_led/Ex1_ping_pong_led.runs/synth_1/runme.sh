...
HD_PWD='C:/Users/ana01/Desktop/Ex1_ping_pong_led/Ex1_ping_pong_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ping_pong.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ping_pong.tcl
